...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/tournament-styles.css')); ?>">
    <!-- Toastr CSS -->
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a href="/" class="sidebar-brand">
                    <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="OnePickleball" width="74px">
                </a>
            ...
            <nav class="sidebar-nav" id="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('homeyard.overview')); ?>" class="nav-item">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('homeyard.tournaments.index')); ?>" class="nav-item">
                        <span class="nav-icon">🏆</span>
                        <span class="nav-text">Giải đấu</span>
                        
                    </a>

                    <a href="<?php echo e(route('homeyard.matches')); ?>" class="nav-item">
                        <span class="nav-icon">🎾</span>
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('homeyard.stadiums.index')); ?>" class="nav-item">
                        <span class="nav-icon">🏢</span>
                        <span class="nav-text">Quản Lý Cụm Sân</span>
                    </a>
                    <a href="<?php echo e(route('homeyard.courts')); ?>" class="nav-item">
                        <span class="nav-icon">🏟️</span>
                        <span class="nav-text">Quản Lý Sân</span>
                    </a>
                    <a href="<?php echo e(route('homeyard.bookings')); ?>" class="nav-item">
                        <span class="nav-icon">📅</span>
                        <span class="nav-text">Đặt Sân</span>
                    </a>
                    <a href="<?php echo e(route('homeyard.socials.index')); ?>" class="nav-item">
                        <span class="nav-icon">🎾</span>
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('homeyard.athletes')); ?>" class="nav-item">
                        <span class="nav-icon">👥</span>
                        <span class="nav-text">Vận động viên</span>
                        
                    </a>
                    <a href="<?php echo e(route('homeyard.rankings')); ?>" class="nav-item">
                        <span class="nav-icon">🏅</span>
    ...
    <script>
        ...
        function initializeActiveTab() {
            <?php if(session('activeTab')): ?>
                showConfigTab('<?php echo e(session('activeTab')); ?>');
            <?php endif; ?>
        }
        ...
        <?php if(session('step')): ?>
            setTimeout(function() {
                nextStep(<?php echo e(session('step')); ?>);
            }, 500);
        <?php endif; ?>
...
<?php /**PATH D:\laragon\www\pickleball_booking\resources\views/layouts/homeyard.blade.php ENDPATH**/ ?>