        ...
        <div class="container">
            ...
            <header class="top-header">
                ...
                <div class="header-right">
                    ...
                    <div class="header-user">
                        <div class="user-avatar"><?php echo e(auth()->user()->getInitials()); ?></div>
                        <div class="user-info">
                            <div class="user-name"><?php echo e(auth()->user()->name); ?></div>
                            <div class="user-role"><?php echo e(auth()->user()->getFirstRoleName()); ?></div>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            ...
                            <div class="stat-value"><?php echo e($stats['ongoing'] ?? 0); ?></div>
                        </div>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            ...
                            <div class="stat-value"><?php echo e($stats['upcoming'] ?? 0); ?></div>
                        </div>
            ...
            <div class="tournament-grid" id="tournamentGrid">
                <?php $__empty_1 = true; $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="tournament-card fade-in" data-tournament-id="<?php echo e($item->id); ?>" data-status="<?php echo e($statusText); ?>" data-format="<?php echo e($formatText); ?>"
                        data-location="<?php echo e($item->location ?? 'N/A'); ?>" data-name="<?php echo e($item->name); ?>"
                        data-date="<?php echo e(strtotime($item->start_date)); ?>">
                        ...
                        <div class="tournament-header">
                            ...
                            <h3 class="tournament-title"><?php echo e($item->name); ?></h3>
                            <div class="tournament-date">📅 <?php echo e(date('d/m/Y', strtotime($item->start_date))); ?>
                        ...
                        <div class="tournament-body">
                            <div class="tournament-meta">
                                <div class="meta-item">
                                    ...
                                    <div class="meta-value"><?php echo e($athleteCount); ?>/<?php echo e($maxParticipants); ?> VĐV</div>
                                </div>
                                <div class="meta-item">
                                    <div class="meta-label">Địa điểm</div>
                                    <div class="meta-value"><?php echo e($item->location ?? 'N/A'); ?></div>
                                </div>
                                <div class="meta-item">
                                    <div class="meta-label">Loại giải</div>
                                    <div class="meta-value"><?php echo e($formatText); ?></div>
                                </div>
                                <div class="meta-item">
                                    <div class="meta-label">Giải thưởng</div>
                                    <div class="meta-value">
                                        <?php echo e($item->prizes ? number_format($item->prizes, 0, ',', '.') . ' ₫' : 'N/A'); ?>
                            ...
                            <div class="tournament-progress">
                                <div class="progress-label">
                                    <span>Đăng ký</span>
                                    <span><?php echo e($athleteCount); ?>/<?php echo e($maxParticipants); ?> (<?php echo e($progress); ?>%)</span>
                                </div>
                            ...
                            <div class="tournament-footer">
                                ...
                                <button class="btn btn-secondary btn-sm" onclick="openEditModal(<?php echo e($item->id); ?>)">
                                    ✏️
                                </button>
                                <a class="btn btn-secondary btn-sm" href="<?php echo e(route('homeyard.tournaments.config', $item->id)); ?>">
                                    ⚙️
                                </a>
                            </div>
                        </div>
            ...
            <div class="pagination">
                <?php if($tournaments->onFirstPage()): ?>
                    <button class="pagination-btn" disabled>←</button>
                <?php else: ?>
                    <a href="<?php echo e($tournaments->previousPageUrl()); ?>" class="pagination-btn">←</a>
                <?php endif; ?>

                <?php $__currentLoopData = $tournaments->getUrlRange(1, $tournaments->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($page == $tournaments->currentPage()): ?>
                        <button class="pagination-btn active" disabled><?php echo e($page); ?></button>
                    <?php else: ?>
                        <a href="<?php echo e($url); ?>" class="pagination-btn"><?php echo e($page); ?></a>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php if($tournaments->hasMorePages()): ?>
                    <a href="<?php echo e($tournaments->nextPageUrl()); ?>" class="pagination-btn">→</a>
                <?php else: ?>
                    <button class="pagination-btn" disabled>→</button>
                <?php endif; ?>
            </div>
    ...
    <div class="modal" id="createModal">
        <div class="modal-content">
            <form id="tournamentForm" method="POST" enctype="multipart/form-data"
                action="<?php echo e(route('homeyard.tournaments.store')); ?>">
                ...
                <div class="modal-body" style="max-height: calc(100vh - 250px); overflow-y: auto;">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <?php if($availableReferees->isEmpty()): ?>
                        ...
                        <?php else: ?>
                            <select name="referee_ids[]" class="form-select" multiple size="4" style="height: auto;">
                                <?php $__currentLoopData = $availableReferees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($referee->id); ?>">
                                        <?php echo e($referee->name); ?> (<?php echo e($referee->email); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $__env->make('components.media-uploader', [
                            'model' => $tournament,
                            'collection' => 'banner',
                            'name' => 'banner',
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function exportToExcel() {
            ...
            window.location.href = '<?php echo e(route('homeyard.tournaments.export')); ?>';
        }
        ...
        function toggleSelectAll() {
         ...
         function deleteBulkTournaments() {
             ...
             // Send delete request
             fetch('<?php echo e(route('homeyard.tournaments.bulk-delete')); ?>', {
                 method: 'POST',
                 headers: {
...
<?php echo $__env->make('layouts.homeyard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\pickleball_booking\resources\views/home-yard/tournaments/tournaments.blade.php ENDPATH**/ ?>