        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="slug" id="slug" class="form-control" value="{{ $news->slug }}" readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <img id="preview-image" src="{{ $news->image ? asset('storage/'.$news->image) : '#' }}" alt="Preview Image" style="max-width:200px;" {{ $news->image ? '' : 'style=display:none;' }}>
                    </div>
                </div>
