...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('admin.instructors.update', $instructor->id) }}" method="POST" enctype="multipart/form-data" id="instructorForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $instructor->name) }}" placeholder="Nhập tên giảng viên" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="bio" id="bio" class="form-control @error('bio') is-invalid @enderror"
                                    value="{{ old('bio', $instructor->bio) }}" placeholder="Ví dụ: Huấn luyện viên Pickleball chuyên nghiệp">
                                @error('bio')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                                    style="min-height:150px;" placeholder="Mô tả chi tiết về giảng viên">{{ old('description', $instructor->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="experience_years" id="experience_years" class="form-control @error('experience_years') is-invalid @enderror"
                                            value="{{ old('experience_years', $instructor->experience_years ?? 0) }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="student_count" id="student_count" class="form-control @error('student_count') is-invalid @enderror"
                                            value="{{ old('student_count', $instructor->student_count ?? 0) }}" min="0">
                                        @error('student_count')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total_hours" id="total_hours" class="form-control @error('total_hours') is-invalid @enderror"
                                            value="{{ old('total_hours', $instructor->total_hours ?? 0) }}" min="0">
                                        @error('total_hours')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="price_per_session" id="price_per_session" class="form-control @error('price_per_session') is-invalid @enderror"
                                            value="{{ old('price_per_session', $instructor->price_per_session ?? 0) }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror"
                                            value="{{ old('phone', $instructor->phone) }}" placeholder="0123456789">
                                        @error('phone')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="zalo" id="zalo" class="form-control @error('zalo') is-invalid @enderror"
                                    value="{{ old('zalo', $instructor->zalo) }}" placeholder="Zalo ID hoặc số điện thoại">
                                @error('zalo')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="experiences-container">
                                @forelse($instructor->experiences as $index => $exp)
                                    <div class="experience-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="mb-2">
                                            <label class="form-label">Chức vụ / Tiêu đề</label>
                                            <input type="text" name="experiences[{{ $index }}][title]" class="form-control" placeholder="Ví dụ: Huấn luyện viên chính" value="{{ $exp->title }}">
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Tổ chức</label>
                                            <input type="text" name="experiences[{{ $index }}][organization]" class="form-control" placeholder="Ví dụ: CLB Pickleball Saigon Elite" value="{{ $exp->organization }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Năm bắt đầu</label>
                                                    <input type="number" name="experiences[{{ $index }}][start_year]" class="form-control" placeholder="2020" min="1900" value="{{ $exp->start_year }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Năm kết thúc</label>
                                                    <input type="number" name="experiences[{{ $index }}][end_year]" class="form-control" placeholder="2025 (nếu hiện tại để trống)" value="{{ $exp->end_year }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Mô tả</label>
                                            <textarea name="experiences[{{ $index }}][description]" class="form-control" style="min-height: 100px;" placeholder="Mô tả công việc">{{ $exp->description }}</textarea>
                                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="certifications-container">
                                @forelse($instructor->certifications as $index => $cert)
                                    <div class="certification-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="mb-2">
                                            <label class="form-label">Tên chứng chỉ</label>
                                            <input type="text" name="certifications[{{ $index }}][title]" class="form-control" placeholder="Ví dụ: IPTPA Certified Coach" value="{{ $cert->title }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Tổ chức cấp</label>
                                                    <input type="text" name="certifications[{{ $index }}][issuer]" class="form-control" placeholder="Ví dụ: International Pickleball Association" value="{{ $cert->issuer }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Năm cấp</label>
                                                    <input type="number" name="certifications[{{ $index }}][year]" class="form-control" placeholder="2020" min="1900" value="{{ $cert->year }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="certifications[{{ $index }}][is_award]" class="form-check-input" value="1" {{ $cert->type === 'achievement' ? 'checked' : '' }}>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="methods-container">
                                @forelse($instructor->teachingMethods as $index => $method)
                                    <div class="method-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="mb-2">
                                            <label class="form-label">Tên phương pháp</label>
                                            <input type="text" name="teaching_methods[{{ $index }}][title]" class="form-control" placeholder="Ví dụ: Cá nhân hóa" value="{{ $method->title }}">
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Mô tả</label>
                                            <textarea name="teaching_methods[{{ $index }}][description]" class="form-control" style="min-height: 80px;" placeholder="Mô tả phương pháp">{{ $method->description }}</textarea>
                                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="packages-container">
                                @forelse($instructor->packages as $index => $package)
                                    <div class="package-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="mb-2">
                                            <label class="form-label">Tên gói</label>
                                            <input type="text" name="packages[{{ $index }}][name]" class="form-control" placeholder="Ví dụ: Buổi lẻ, Gói 4 buổi" value="{{ $package->name }}">
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Mô tả</label>
                                            <input type="text" name="packages[{{ $index }}][description]" class="form-control" placeholder="Mô tả gói" value="{{ $package->description }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    <label class="form-label">Giá (đ)</label>
                                                    <input type="number" name="packages[{{ $index }}][price]" class="form-control" placeholder="500000" min="0" value="{{ $package->price }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    <label class="form-label">Giảm giá (%)</label>
                                                    <input type="number" name="packages[{{ $index }}][discount_percent]" class="form-control" placeholder="0" min="0" max="100" value="{{ $package->discount_percent }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-2">
                                                    <label class="form-label">Số buổi</label>
                                                    <input type="number" name="packages[{{ $index }}][sessions_count]" class="form-control" placeholder="1" min="0" value="{{ $package->sessions_count }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="packages[{{ $index }}][is_active]" class="form-check-input" value="1" {{ $package->is_active ? 'checked' : '' }}>
                                                Kích hoạt
                                            </label>
                                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="locations-container">
                                @forelse($instructor->locations as $index => $location)
                                    <div class="location-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Quận/Huyện</label>
                                                    <input type="text" name="locations[{{ $index }}][district]" class="form-control" placeholder="Ví dụ: Quận 2" value="{{ $location->district }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    <label class="form-label">Thành phố</label>
                                                    <input type="text" name="locations[{{ $index }}][city]" class="form-control" placeholder="Ví dụ: TP. HCM" value="{{ $location->city }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Tên sân</label>
                                            <textarea name="locations[{{ $index }}][venues]" class="form-control" style="min-height: 80px;" placeholder="Ví dụ: Sân Rạch Chiếc, Sân An Phú">{{ $location->venues }}</textarea>
                                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div id="schedules-container">
                                @forelse($instructor->schedules as $index => $schedule)
                                    <div class="schedule-item mb-3 p-3 border rounded" data-index="{{ $index }}">
                                        <div class="mb-2">
                                            <label class="form-label">Các ngày</label>
                                            <input type="text" name="schedules[{{ $index }}][days]" class="form-control" placeholder="Ví dụ: Thứ 2 - Thứ 6" value="{{ $schedule->days }}">
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Giờ học</label>
                                            <input type="text" name="schedules[{{ $index }}][time_slots]" class="form-control" placeholder="Ví dụ: 06:00 - 08:00, 17:00 - 21:00" value="{{ $schedule->time_slots }}">
                                        </div>
    ...
    <script>
        let experienceCount = {{ $instructor->experiences->count() }};
        let certificationCount = {{ $instructor->certifications->count() }};
        let methodCount = {{ $instructor->teachingMethods->count() }};
        let packageCount = {{ $instructor->packages->count() }};
        let locationCount = {{ $instructor->locations->count() }};
        let scheduleCount = {{ $instructor->schedules->count() }};
