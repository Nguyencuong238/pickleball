...
<div class="create-container">
    <div class="create-header">
        <h2>🏆 Tạo Câu Lạc Bộ/Nhóm Mới</h2>
        <p>Bắt đầu hành trình của bạn với cộng đồng pickleball</p>
    </div>
        ...
        <form action="{{ route('clubs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <small style="color: #6b7280; display: block; margin-top: 5px;">Kích thước đề xuất: 1200x300 px</small>
                    <div id="bannerPreviewContainer" style="margin-top: 15px;"></div>
                </div>
                            ...
                            reader.onload = function(event) {
                                container.innerHTML = `
                                    <div style="position: relative; display: inline-block; width: 100%;">
                                        ...
                                        <div style="margin-top: 8px; color: #6b7280; font-size: 0.85rem;">
                                            [BANNER] ${file.name} (${(file.size / 1024).toFixed(2)} KB)
                                        </div>
                                    </div>
                                `;
                            };
                ...
                <div class="form-group">
                    <label for="objectives">Muc Tieu Hoat Dong</label>
            ...
            <!-- Nút Hành Động -->
            <div class="btn-group">
                <button type="submit" class="btn-submit">✓ Tạo Câu Lạc Bộ/Nhóm</button>
                <a href="{{ route('clubs.index') }}" class="btn-cancel">← Quay Lại</a>
            </div>
        </form>
    </div>
</div>
