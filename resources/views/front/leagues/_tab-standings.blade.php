{{-- Tab 3: Bảng xếp hạng (public read-only) --}}
@if($league->standings->count() > 0)
    <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; min-width: 600px;">
            ...
            <tbody>
                @foreach($league->standings->sortBy('rank') as $standing)
                    @php
...
@else
    <div style="text-align: center; padding: 40px 20px;">
        ...
        <p style="color: #9ca3af;">Bảng xếp hạng sẽ được cập nhật khi có kết quả thi đấu.</p>
    </div>
@endif
