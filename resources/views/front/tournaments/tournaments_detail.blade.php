...
@section('content')
    <section class="tournament-hero">
        <div class="hero-background">
            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1920 600'%3E%3Cdefs%3E%3ClinearGradient id='hero-grad' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color:%2300D9B5;stop-opacity:1' /%3E%3Cstop offset='100%25' style='stop-color:%230099CC;stop-opacity:1' /%3E%3C/linearGradient%3E%3C/defs%3E%3Crect fill='url(%23hero-grad)' width='1920' height='600'/%3E%3Ctext x='960' y='300' font-family='Arial' font-size='72' fill='white' text-anchor='middle' dominant-baseline='middle' font-weight='bold'%3E%3C/text%3E%3C/svg%3E"
                            ...
                            @if ($tournament->categories)
                                @foreach ($tournament->categories as $category)
                                    @php
                                        ...
                                        $isAvailable =
                                            in_array($category->status, ['open', 'ongoing']) &&
                                            $athleteCount < $category->max_participants;
                                        $statusText = '';
