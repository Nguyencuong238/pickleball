    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header-content">
                ...
                <p class="page-description">Kết nối với các huấn luyện viên chuyên nghiệp, nhiều năm kinh nghiệm, sẵn sàng
                    đồng hành cùng bạn trên hành trình chinh phục Pickleball</p>
        ...
        <div class="container">
            <div class="cta-card">
                <div class="cta-content">
                    ...
                    <p class="cta-description">Đăng ký trở thành giảng viên trên OnePickleball.vn và kết nối với hàng ngàn
                        học viên tiềm năng trên toàn quốc.</p>
                ...
                <div class="cta-image">
                    <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M160 150 L240 150 M200 110 L200 190" stroke="rgba(255,255,255,0.5)" stroke-width="8"
