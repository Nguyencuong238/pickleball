    ...
    <div class="container">
        ...
        <header class="top-header">
            <div class="header-left">
                ...
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span class="breadcrumb-item">Tạo Mới</span>
                </div>
            </div>
        </header>
        ...
        <div class="card fade-in">
            <div class="card-header">
                <h3 class="card-title">➕ Tạo Nhóm/CLB Mới</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('homeyard.clubs.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-input @error('type') is-invalid @enderror" required>
                                ...
                                <option value="club" {{ old('type') === 'club' ? 'selected' : '' }}>Câu lạc bộ</option>
                                <option value="group" {{ old('type') === 'group' ? 'selected' : '' }}>Nhóm</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <select name="provinces[]" class="form-input select2-multiple @error('provinces') is-invalid @enderror" multiple required>
                                @foreach ($provinces as $province)
                                    <option value="{{ $province->id }}" 
                                        {{ in_array($province->id, old('provinces', [])) ? 'selected' : '' }}>
                                        {{ $province->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-area" id="imageUploadArea">
                                ...
                                <div class="preview-area d-none" id="imagePreview">
                                    <img id="imagePreviewImg" src="" alt="Preview" style="height: 100%; object-fit: cover; border-radius: 6px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-area" id="bannerUploadArea">
                                ...
                                <div class="preview-area d-none" id="bannerPreview">
                                    <img id="bannerPreviewImg" src="" alt="Preview" style="height: 100%; object-fit: cover; border-radius: 6px;">
                    ...
                    <div style="margin-bottom: 40px; padding-bottom: 30px;">
                        <h3 style="font-size: 1.1rem; font-weight: 700; margin-bottom: 15px;">👥 Thành Viên Ban Đầu</h3>
                    ...
                    <div style="display: flex; gap: 10px; justify-content: flex-end; padding-top: 20px; border-top: 1px solid #e2e8f0;">
                        ...
                        <button type="submit" class="btn btn-primary">➕ Tạo Nhóm/CLB</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function setupImageUpload(fieldName) {
        ...
        uploadArea.addEventListener('drop', (e) => {
            ...
            handleFileSelect(fileInput, previewArea, previewImg);
        });
    ...
    function handleFileSelect(fileInput, previewArea, previewImg) {
