    ...
    <form method="POST" action="{{ isset($tournament) ? route('homeyard.tournaments.update', $tournament) : route('homeyard.tournaments.store') }}" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 12px;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button type="button" onclick="addGalleryUrl()" 
                        style="background: #ec4899; color: white; padding: 8px 16px; border-radius: 6px; border: none; cursor: pointer; font-weight: 600; white-space: nowrap;">Thêm</button>
                </div>
            </div>
        ...
        <!-- Buttons -->
         <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: flex-end; padding-top: 20px; border-top: 1px solid #e2e8f0;">
             ...
             <button type="submit" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: white; padding: 10px 20px; border-radius: 6px; border: none; font-weight: 600; cursor: pointer; white-space: nowrap;">
